...
public class LockScreenActivity extends AppCompatActivity {
    @BindView(R.id.mathVebView_lockscreen) MathJaxWebView mathVebView_lockscreen;
    @BindView(R.id.fab_lockscreen_call) FloatingActionButton fab_lockscreen_call;
    @BindView(R.id.fab_lockscreen_unlock) FloatingActionButton fab_lockscreen_unlock;
    @BindView(R.id.fab_lockscreen_mother) FloatingActionButton fab_lockscreen_mother;
    @BindView(R.id.recyclerview_lockscreen_answer) RecyclerView recyclerview_lockscreen_answer;
